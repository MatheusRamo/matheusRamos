---
title: 'Project Polyline From Profile View'
date: '2024-07-01'
lastmod: '2024-07-01'
tags: ['Civil3D', 'Csharp', 'Plugins']
draft: false
summary: 'In this first post, I show each detailed step of the command I created using the Civil3D C# API.'

---

## Introduction

When adjusting surfaces, one of the main challenges in my work is to perform this adjustment quickly and accurately.
...
to use it as a Breakline on the surface motivated me to develop the following command using Civil 3D's C# API.
...
API Developer's Guide - Autodesk Civil 3D - [API Developer's Guide - Autodesk Civil 3D](https://help.autodesk.com/view/CIV3D/2024/ENU/?guid=GUID-DA303320-B66D-4F4F-A4F4-9FBBEC0754E0)